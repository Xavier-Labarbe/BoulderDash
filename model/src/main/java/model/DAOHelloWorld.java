...
// final CallableStatement call = this.getConnection().prepareCall(request);
// call.setInt(1, id);
// call.execute();
// final ResultSet resultSet = call.getResultSet();
// if (resultSet.first()) {
// helloWorld = new HelloWorld(id, resultSet.getString("code"),
...
//
// try {
// final String request = "{call helloworldByCode(?)}";
// final CallableStatement call = this.getConnection().prepareCall(request);
// call.setString(1, code);
// call.execute();
// final ResultSet resultSet = call.getResultSet();
// if (resultSet.first()) {
// helloWorld = new HelloWorld(resultSet.getInt("id"), code,
// resultSet.getString("message"));
// }
// return helloWorld;
// } catch (final SQLException e) {
